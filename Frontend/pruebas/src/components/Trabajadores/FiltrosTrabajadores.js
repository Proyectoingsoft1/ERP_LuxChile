    ...
    <div style={{
      ...
      <div style={{ flex: '1 1 200px' }}>
        ...
        >
          ...
          <option value="logistica">Ì∫ö Log√≠stica</option>
          <option value="rrhh">Ì±• RRHH</option>
          <option value="seguridad">Ìª°Ô∏è Seguridad</option>
        </select>
      </div>
      ...
      <div style={{ flex: '1 1 200px' }}>
        ...
        >
          ...
          <option value="false">‚≠ï Inactivos</option>
        </select>
      </div>
